  ...
  try {
    ...
    const res = await fetch(`${supabaseUrl}/auth/v1/admin/generate_link`, {
      ...
      body: JSON.stringify({
        ...
        email: email,
        options: {
          subject: 'Your Myoozz Events account is ready',
          html: emailHtml,
        }
      }),
    })
