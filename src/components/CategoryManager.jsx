  ...
  return (
    <div style={{ padding: '40px 48px 80px', maxWidth: 720 }}>
      <div style={{ marginBottom: 32 }}>
        <div style={{ fontFamily: 'DM Mono, monospace', fontSize: 11, color: '#F28F3B', textTransform: 'uppercase', letterSpacing: 1, marginBottom: 6 }}>
      ...
      {error && (
        <div style={{ background: '#fde8ea', border: '1px solid #f5b5ba', borderRadius: 6, padding: '10px 14px', color: '#F28F3B', fontSize: 13, marginBottom: 16 }}>
          {error}
          <button onClick={() => setError('')} style={{ float: 'right', background: 'none', border: 'none', cursor: 'pointer', color: '#F28F3B', fontSize: 16 }}>×</button>
        </div>
      )}
