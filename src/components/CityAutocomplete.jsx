...
const S = {
  ...
  inputFocus: { borderColor: '#F28F3B' },
  inputDisabled: { background: '#f2efe9', color: '#7a7060', cursor: 'not-allowed' },
  dropdown: {
    position: 'absolute', top: 'calc(100% + 4px)', left: 0, right: 0,
    background: '#fff', border: '1px solid #d8d2c8', borderRadius: '8px',
  ...
  cityName: {
    fontSize: '14px', fontWeight: 500, color: '#1a1008',
  ...
  status: {
    padding: '10px 12px', fontSize: '13px', color: '#7a7060',
