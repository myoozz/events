  ...
  return(
    <div style={{
      ...
      <div style={{
        ...
        ><svg width="14" height="14" viewBox="0 0 14 14" fill="none" style={{transform:open?'rotate(180deg)':'none',transition:'transform 0.18s ease'}}><path d="M3 5l4 4 4-4" stroke={open?'#2e7d32':'#bc1723'} strokeWidth="1.5" strokeLinecap="round" strokeLinejoin="round"/></svg></button>
