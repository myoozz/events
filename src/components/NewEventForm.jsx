...
const S = {
  ...
  tileActive: {
    borderColor: '#C8102E', background: '#fde8ea',
  },
  btn: {
  ...
  btnRed:  { background: '#C8102E', color: '#fff' },
  btnGhost: {
      ...
      <div style={S.overlay} onClick={(e) => e.target === e.currentTarget && onClose()}>
        <div style={S.modal}>
          ...
          <div style={{ height: '2px', background: '#e8e4dc', margin: '12px 28px 0', borderRadius: '2px' }}>
            <div style={{
              height: '2px', background: '#C8102E', borderRadius: '2px',
        ...
        <div style={{ ...S.modal, maxWidth: '620px' }}>
          ...
          <div style={{ ...S.body, paddingTop: '20px', paddingBottom: '20px' }}>
            ...
            <div style={{ marginTop: '16px' }}>
              ...
              >
                <svg width="14" height="14" viewBox="0 0 14 14" fill="none" style={{transform:showMore?'rotate(180deg)':'none',transition:'transform 0.18s ease',marginRight:5,verticalAlign:'middle',display:'inline-block'}}><path d="M3 5l4 4 4-4" stroke={showMore?'#2e7d32':'#C8102E'} strokeWidth="1.5" strokeLinecap="round" strokeLinejoin="round"/></svg> More details — Agency fee, GST, Proposal date
              </button>
        ...
        <div style={S.modal}>
          ...
          <div style={{ ...S.body, paddingTop: '20px' }}>
            ...
            <div style={{ display: 'grid', gridTemplateColumns: '1fr 1fr', gap: '10px', marginBottom: '10px' }}>
              <div>
                <label style={S.label}>Client / Group <span style={{ color: '#C8102E' }}>*</span></label>
                <input style={S.input} value={a.clientName}
                  onChange={e => set('clientName', e.target.value)}
                  placeholder="e.g. Aditya Birla Group" />
              </div>
            ...
            <div style={{ marginBottom: '10px' }}>
              <label style={S.label}>Event Name <span style={{ color: '#C8102E' }}>*</span></label>
            ...
            <div style={{ display: 'grid', gridTemplateColumns: '1fr 1fr', gap: '10px', marginBottom: '10px' }}>
              <div>
                <label style={S.label}>Event Type <span style={{ color: '#C8102E' }}>*</span></label>
            ...
            <div style={{ display: 'grid', gridTemplateColumns: '1fr 1fr', gap: '10px' }}>
              <div>
                ...
                <input type="range" min="0" max="30" step="0.5"
                  value={a.agencyFee}
                  onChange={e => set('agencyFee', parseFloat(e.target.value))}
                  style={{ width: '100%', accentColor: '#C8102E', marginTop: '6px' }} />
              </div>
              <div>
                <label style={S.label}>GST</label>
                <select style={S.input} value={a.gst}
            ...
            {EVENT_TYPES.map(t => (
              ...
              >
                ...
                <span style={{
                  ...
                  color: a.eventType === t.value ? '#C8102E' : '#1a1008',
                }}>{t.label}</span>
              </button>
            ))}
          </div>
                ...
                {selectedType.sub.map(sub => (
                  <button key={sub}
                    style={{
                      ...
                      border: '1px solid',
                      borderColor: a.subCategory === sub ? '#C8102E' : '#d8d2c8',
                      background: a.subCategory === sub ? '#fde8ea' : '#fff',
                      color: a.subCategory === sub ? '#C8102E' : '#2c2518',
          ...
          {SEATING.map(f => (
            ...
            >
              <div style={{
                ...
                color: a.seatingFormat === f ? '#C8102E' : '#1a1008',
              }}>
                {f}
              </div>
            </button>
            ...
            >
              <div>
                <div style={{
                  ...
                  color: a.budgetTier === t.value ? '#C8102E' : '#1a1008',
                }}>
                  {t.label}
                </div>
              ...
              {a.budgetTier === t.value && (
                <span style={{ color: '#C8102E', fontSize: '18px', flexShrink: 0 }}>✓</span>
              )}
            </button>
          ))}
        </div>
          ...
          <div style={{ display: 'grid', gridTemplateColumns: '1fr 1fr', gap: '8px' }}>
            {[
              ...
              >
                <div style={{
                  fontSize: '13px', fontWeight: 600,
                  color: a.hasSubEvents === val ? '#C8102E' : '#1a1008',
                }}>
                  {label}
                </div>
              </button>
          ...
          {users.map(u => (
            ...
            >
              <div style={{
                ...
                background: a.agencyPocId === u.id ? '#C8102E' : '#1a1008',
              ...
              <div style={{ flex: 1, textAlign: 'left' }}>
                <div style={{
                  fontSize: '13px', fontWeight: 600,
                  color: a.agencyPocId === u.id ? '#C8102E' : '#1a1008',
                }}>
                  {u.full_name}
                </div>
                <div style={{
      ...
      {rows.map((row, i) => (
        <div key={row.label} style={{
          ...
          <button
            style={{
              background: 'none', border: 'none', cursor: 'pointer',
              color: '#C8102E', fontSize: '11px', padding: '2px 8px',
              fontFamily: "'DM Sans', sans-serif",
            }}
