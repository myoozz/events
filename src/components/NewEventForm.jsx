        ...
        <div style={{ ...S.modal, maxWidth: '620px' }}>
          ...
          <div style={{ ...S.body, paddingTop: '20px', paddingBottom: '20px' }}>
            ...
            <div style={{ marginTop: '16px' }}>
              ...
              >
                <svg width="14" height="14" viewBox="0 0 14 14" fill="none" style={{transform:showMore?'rotate(180deg)':'none',transition:'transform 0.18s ease',marginRight:5,verticalAlign:'middle',display:'inline-block'}}><path d="M3 5l4 4 4-4" stroke={showMore?'#2e7d32':'#bc1723'} strokeWidth="1.5" strokeLinecap="round" strokeLinejoin="round"/></svg> More details — Agency fee, GST, Proposal date
              </button>
