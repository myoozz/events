  ...
  return (
    <div style={{
      ...
      <div style={{
        ...
        background: 'var(--app-accent)', borderRadius: '8px',
  ...
  render() {
    if (this.state.error) return (
      <div style={{
        ...
        <div style={{ width: '32px', height: '32px', background: 'var(--app-accent)', borderRadius: '8px', display: 'flex', alignItems: 'center', justifyContent: 'center', fontSize: '11px', fontWeight: 700, color: '#fff' }}>ME</div>
        ...
        <button
          ...
          style={{ marginTop: '8px', padding: '10px 20px', background: 'var(--app-accent)', color: '#fff', border: 'none', borderRadius: '7px', fontSize: '13px', fontWeight: 600, cursor: 'pointer' }}>
          Go to home
        </button>
      </div>
    )
